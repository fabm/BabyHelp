...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var b = {timestamp: "D9EF", version: "4.2.2", revision: "f98db6d8", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return{define: function (a, d) {
            ...
            function i(b, g, m, q) {
                b = {name: a, sender: this, editor: b, data: g, listenerData: c, stop: m, cancel: q, removeListener: l};
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (a, f) {
            ...
            for (var a = [].concat(a), b, d = [], c = 0; c < a.length; c++)if (b = a[c])/@import|
            [
                {}
            ] /
            .
            test(b) ? d.push("<style>" + b + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + b + '">');
            return d.join("")
    ...
    (function () {
        ...
        }, e = {abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1}, h = CKEDITOR.dom.walker.bogus(), j = new CKEDITOR.dom.walker.whitespaces, i = new CKEDITOR.dom.walker.bookmark, l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {clone: function () {
            ...
            return function (b) {
                var c = this.collapsed, d = {container: this.startContainer, offset: this.startOffset}, g = {container: this.endContainer, offset: this.endOffset};
                if (b) {
                    a(d);
                    c || a(g)
                }
                return{start: d.container.getAddress(b), end: c ? null : g.container.getAddress(b), startOffset: d.offset, endOffset: g.offset, normalized: b,
                    collapsed: c, is2: true}
            }
    ...
    (function () {
        ...
        function f(a) {
            ...
            return a._.filterFunction = function (d, e, f, h, k, q, o) {
                ...
                if (e) {
                    var n = d.name, f = e.elements[n], t = e.generic, e = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {},
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, d) {
            ...
            if (typeof b == "string")b = h(b); else if (b instanceof CKEDITOR.style) {
                ...
                d = {};
                b = e.attributes;
                d[e.element] = e = {styles: e.styles, requiredStyles: e.styles && CKEDITOR.tools.objectKeys(e.styles)};
                if (b) {
                    b = r(b);
            ...
            if (typeof a == "string") {
                ...
                g = {name: d.element, attributes: o, classes: o["class"] ?
        ...
        var s = {styles: 1, attributes: 1, classes: 1}, C = {styles: "requiredStyles", attributes: "requiredAttributes",
            classes: "requiredClasses"}, y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, o = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, u = CKEDITOR.filter.transformationsTools = {sizeToStyle: function (a) {
    ...
    (function () {
        ...
        var E = /(?:&nbsp;|\xa0)$/, B = "{cke_protected}", r = CKEDITOR.dtd, x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], z = CKEDITOR.tools.extend({}, r.$blockLimit, r.$block), s = {elements: {}, attributeNames: [
            [/^on/, "data-cke-pa-on"]
        ]}, C = {elementNames: [
            [/^cke:/, ""],
            [/^\?xml:namespace$/, ""]
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, j = a.elementMode,
                i = a.fire("uiSpace", {space: "top", html: ""}).html, l = a.fire("uiSpace", {space: "bottom", html: ""}).html;
            f || (f = CKEDITOR.addTemplate("maincontainer", '<{outerEl} id="cke_{name}" class="{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir="{langDir}" lang="{langCode}" roles="application" aria-labelledby="cke_{name}_arialbl"><span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span><{outerEl} class="cke_inner cke_reset" roles="presentation">{topHtml}<{outerEl} id="{contentId}" class="cke_contents cke_reset" roles="presentation"></{outerEl}>{bottomHtml}</{outerEl}></{outerEl}>'));
            b = CKEDITOR.dom.element.createFromHtml(f.output({id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: [a.lang.editor, a.name].join(", "), topHtml: i ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" roles="presentation" style="height:auto">' + i + "</span>" : "", contentId: a.ui.spaceId("contents"), bottomHtml: l ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" roles="presentation">' + l + "</span>" : "", outerEl: CKEDITOR.env.ie ? "span" : "div"}));
            if (j == CKEDITOR.ELEMENT_MODE_REPLACE) {
                c.hide();
                b.insertAfter(c)
            } else c.append(b);
    ...
    (function () {
        ...
        var m = function () {
                ...
                for (var n = i[n.getName()], p = 0, j = a.getChildren(), m = j.count(), l = -1, v = -1, E = 0, B = g.contains(i.$list); p < m; ++p) {
                    ...
                    if (b(g)) {
                        ...
                        if (B && f in CKEDITOR.dtd.$list)k = k.concat(c(g, d)); else {
                            ...
                            l == -1 && !h && (l = p);
                            h || (v = p);
                            k.push({isElement: 1, isLineBreak: E, isBlock: g.isBlockBoundary(), hasBlockSibling: e, node: g, name: f, allowed: h});
                            e = E = 0
                        }
            ...
            var i = CKEDITOR.dtd, n = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, j = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, m = CKEDITOR.tools.extend({}, i.$inline);
            delete m.br;
            return function (n, l, z) {
                ...
                if (!C.checkReadOnly()) {
                    var o = (new CKEDITOR.dom.elementPath(C.startContainer, C.root)).blockLimit || C.root, l = {type: l, dontFilter: y, editable: n, editor: s, range: C, blockLimit: o, mergeCandidates: [], zombies: []}, s = l.range, y = l.mergeCandidates, u, I, G, D;
    ...
    (function () {
        ...
        var r = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1,
            keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, x = {a: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, z = /\s*(?:;\s*|$)/, s = /#\((.+?)\)/g, C = CKEDITOR.dom.walker.bookmark(0, 1), y = CKEDITOR.dom.walker.whitespaces(1);
        ...
        CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {labeledElement: function (b, a, d, e) {
            ...
            if (!(3 > arguments.length)) {
                ...
                CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                    ...
                    var b = ['<iframe frameborder="0" allowtransparency="0" class="cke_dialog_ui_input_file" roles="presentation" id="',
    ...
    (function () {
        ...
        var s = CKEDITOR.tools.cssLength, S = '<div class="cke_reset_all {editorId} {editorDialogClass} {hidpi}" dir="{langDir}" lang="{langCode}" roles="dialog" aria-labelledby="cke_dialog_title_{id}"><table class="cke_dialog ' + CKEDITOR.env.cssClass + ' cke_{langDir}" style="position:absolute" roles="presentation"><tr><td roles="presentation"><div class="cke_dialog_body" roles="presentation"><div id="cke_dialog_title_{id}" class="cke_dialog_title" roles="presentation"></div><a id="cke_dialog_close_button_{id}" class="cke_dialog_close_button" href="javascript:void(0)" title="{closeTitle}" roles="button"><span class="cke_label">X</span></a><div id="cke_dialog_tabs_{id}" class="cke_dialog_tabs" roles="tablist"></div><table class="cke_dialog_contents" roles="presentation"><tr><td id="cke_dialog_contents_{id}" class="cke_dialog_contents_body" roles="presentation"></td></tr><tr><td id="cke_dialog_footer_{id}" class="cke_dialog_footer" roles="presentation"></td></tr></table></div></td></tr></table></div>';
        ...
        CKEDITOR.dialog.prototype = {destroy: function () {
            ...
            commitContent: function () {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    c = CKEDITOR.dom.element.createFromHtml(['<a class="cke_dialog_tab"', 0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ? ' style="display:none"' : "", ' id="', e, '"', d.gecko && 10900 <= d.version && !d.hc ? "" : ' href="javascript:void(0)"', ' tabIndex="-1" hidefocus="true" roles="tab">',
                        a.label, "</a>"].join(""));
    ...
    (function () {
        function q(a) {
            ...
            if (l) {
                var b = CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml(u.output({content: l, id: a.id, langDir: a.lang.dir, langCode: a.langCode, name: a.name, style: "display:none;z-index:" + (i.baseFloatZIndex - 1), topId: a.ui.spaceId("top"), voiceLabel: a.lang.editorPanel + ", " +
                    a.name}))), p = CKEDITOR.tools.eventsBuffer(500, o), e = CKEDITOR.tools.eventsBuffer(100, o);
                b.unselectable();
        ...
        var u = CKEDITOR.addTemplate("floatcontainer", '<div id="cke_{name}" class="cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' + CKEDITOR.env.cssClass + '" dir="{langDir}" title="' + (CKEDITOR.env.gecko ? " " : "") + '" lang="{langCode}" roles="application" style="{style}" aria-labelledby="cke_{name}_arialbl"><span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span><div class="cke_inner"><div id="{topId}" class="cke_top" roles="presentation">{content}</div></div></div>'),
    ...
    (function () {
        ...
        var j = {b: "strong", u: "u", i: "em", color: "span", size: "span", quote: "blockquote", code: "code", url: "a",
            ...
            indecision: ":|", angry: ">:(", angel: "o:)", cool: "8-)", devil: ">:-)", crying: ";(", kiss: ":-*"}, y = {}, p = [], q;
        for (q in o)y[o[q]] = q, p.push(o[q].replace(/\(|\)|\:|\/|\*|\-|\|/g, function (a) {
            return"\\" + a
        }));
        var p = RegExp(p.join("|"), "g"), A = function () {
        ...
        CKEDITOR.BBCodeParser.prototype = {parse: function (a) {
            for (var b, c, i = 0; b = this._.bbcPartsRegex.exec(a);) {
                c = b.index;
                if (c > i)this.onText(a.substring(i, c), 1);
                i = this._.bbcPartsRegex.lastIndex;
                if ((c = (b[1] || b[3] || "").toLowerCase()) && !j[c])this.onText(b[0]); else if (b[1]) {
                    var e = j[c], g = {}, h = {};
                    if (b = b[2])if ("list" == c && (isNaN(b) ? /^[a-z]+$/.test(b) ? b = "lower-alpha" : /^[A-Z]+$/.test(b) && (b = "upper-alpha") : b = "decimal"), v[c]) {
                        "size" == c && (b += "%");
                        h[v[c]] = b;
                        b = g;
                        var f = "", d = void 0;
                        for (d in h)var r = (d + ":" + h[d]).replace(z, ";"),
                            f = f + r;
                        b.style = f
                    } else w[c] && (g[w[c]] = b);
                    if ("email" == c || "img" == c)g.bbcode = c;
                    this.onTagOpen(e, g, CKEDITOR.dtd.$empty[e])
                } else if (b[3])this.onTagClose(j[c])
            }
            if (a.length > i)this.onText(a.substring(i, a.length), 1)
        }};
        CKEDITOR.htmlParser.fragment.fromBBCode = function (a) {
            function b(e) {
                if (0 < h.length)for (var a = 0; a < h.length; a++) {
                    var b = h[a], c = b.name, g = CKEDITOR.dtd[c], f = d.name && CKEDITOR.dtd[d.name];
                    if ((!f || f[c]) && (!e || !g || g[e] || !CKEDITOR.dtd[e]))b = b.clone(), b.parent = d, d = b, h.splice(a, 1), a--
                }
            }

            function c(a, e) {
                var b = d.children.length,
                    c = 0 < b && d.children[b - 1], b = !c && s.getRule(k[d.name], "breakAfterOpen"), c = c && c.type == CKEDITOR.NODE_ELEMENT && s.getRule(k[c.name], "breakAfterClose"), g = a && s.getRule(k[a], e ? "breakBeforeClose" : "breakBeforeOpen");
                f && (b || c || g) && f--;
                f && a in x && f++;
            ...
            function i(a, e) {
                c(a.name, 1);
                var e = e || d || g, b = e.children.length;
                a.previous = 0 < b && e.children[b - 1] || null;
                a.parent = e;
                e.children.push(a);
            ...
            e.onTagOpen = function (a, g, f) {
                ...
                if (CKEDITOR.dtd.$removeEmpty[a])h.push(l); else {
                    var t = d.name, n = t && (CKEDITOR.dtd[t] || (d._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span));
                    if (n && !n[a]) {
                        var n = !1, j;
                        a == t ? i(d, d.parent) : (a in CKEDITOR.dtd.$listItem ? (e.onTagOpen("ul", {}), j = d) : (i(d, d.parent), h.unshift(d)), n = !0);
            ...
            e.onTagClose = function (a) {
                for (var e = h.length - 1; 0 <= e; e--)if (a == h[e].name) {
                    h.splice(e, 1);
                    return
                }
                for (var b = [], c = [], g = d; g.type && g.name != a;)g._.isBlockLike || c.unshift(g), b.push(g), g = g.parent;
                if (g.type) {
                    for (e = 0; e < b.length; e++)a = b[e], i(a, a.parent);
                    d = g;
                    i(g, g.parent);
                    g == d && (d = d.parent);
                    h = h.concat(c)
            ...
            e.onText = function (a) {
                ...
                if (!e || e["#"])c(), b(), a.replace(/(\r\n|[\r\n])|[^\r\n]*/g, function (a, e) {
                    if (void 0 !== e && e.length)f++; else if (a.length) {
                        var b = 0;
                        a.replace(p,
                            function (e, c) {
                                i(new CKEDITOR.htmlParser.text(a.substring(b, c)), d);
                                i(new CKEDITOR.htmlParser.element("smiley", {desc: y[e]}), d);
                                b = c + e.length
                            });
                        b != a.length && i(new CKEDITOR.htmlParser.text(a.substring(b, a.length)), d)
                    }
                })
            };
            for (e.parse(CKEDITOR.tools.htmlEncode(a)); d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT;)a = d.parent, i(d, a), d = a;
            return g
        };
        ...
        CKEDITOR.plugins.add("bbcode", {requires: "entities", beforeInit: function (a) {
            ...
            function b(a) {
                var b = a.data, a = CKEDITOR.htmlParser.fragment.fromBBCode(a.data.dataValue),
                    c = new CKEDITOR.htmlParser.basicWriter;
                a.writeHtml(c, i);
                a = c.getHtml(!0);
                b.dataValue = a
            ...
            i.addRules({elements: {blockquote: function (a) {
                ...
                var b;
                if (b = a.attributes.bbcode)"img" == b ? (a.name =
                    "img", a.attributes.src = a.children[0].value, a.children = []) : "email" == b && (a.name = "a", a.attributes.href = "mailto:" + a.children[0].value), delete a.attributes.bbcode
            }, ol: function (a) {
                ...
                a.name = "img";
                var b = a.attributes.desc, h = c.smiley_images[CKEDITOR.tools.indexOf(c.smiley_descriptions,
                    b)], h = CKEDITOR.tools.htmlEncode(c.smiley_path + h);
                a.attributes = {src: h, "data-cke-saved-src": h, title: b, alt: b}
            }}});
            a.dataProcessor.htmlFilter.addRules({elements: {$: function (b) {
                var c = b.attributes, h = CKEDITOR.tools.parseCssText(c.style, 1), f, d = b.name;
                if (d in u)d = u[d]; else if ("span" == d)if (f = h.color)d = "color", f = CKEDITOR.tools.convertRgbToHex(f); else {
                    if (f = h["font-size"])if (c = f.match(/(\d+)%$/))f = c[1], d = "size"
                } else if ("ol" == d || "ul" == d) {
                    if (f = h["list-style-type"])switch (f) {
                        case "lower-alpha":
                            f = "a";
                            break;
                        case "upper-alpha":
                    ...
                    if (f = c.href)-1 !== f.indexOf("mailto:") ? (d = "email", b.children = [new CKEDITOR.htmlParser.text(f.replace("mailto:", ""))], f = "") : ((d = 1 == b.children.length && b.children[0]) && (d.type == CKEDITOR.NODE_TEXT && d.value == f) && (f = ""), d = "url")
                } else if ("img" == d) {
                    b.isEmpty = 0;
                    h = c["data-cke-saved-src"] || c.src;
                    c = c.alt;
                    if (h && -1 != h.indexOf(a.config.smiley_path) && c)return new CKEDITOR.htmlParser.text(o[c]);
                ...
                if ((a = a.next) && a.name in x)return!1
            }}}, 1);
            ...
            a._.elementsPath && (b = a._.elementsPath.filters) && b.push(function (b) {
                ...
                "link" == e && 0 === b.getAttribute("href").indexOf("mailto:") ? e = "email" : "span" == i ? b.getStyle("font-size") ? e = "size" : b.getStyle("color") && (e = "color") : "img" == e && (b = b.data("cke-saved-src") || b.getAttribute("src")) && 0 === b.indexOf(a.config.smiley_path) && (e = "smiley");
                return e
            })
        }})
    })();
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,about,basicstyles,clipboard,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo,bbcode,sourcearea';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,indent-rtl,312,,indent,336,,outdent-rtl,360,,outdent,384,,anchor-rtl,408,,anchor,432,,link,456,,unlink,480,,bulletedlist-rtl,504,,bulletedlist,528,,numberedlist-rtl,552,,numberedlist,576,,redo-rtl,600,,redo,624,,undo-rtl,648,,undo,672,,source-rtl,696,,source,720,', 'icons_hidpi.png'); else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,indent-rtl,312,auto,indent,336,auto,outdent-rtl,360,auto,outdent,384,auto,anchor-rtl,408,auto,anchor,432,auto,link,456,auto,unlink,480,auto,bulletedlist-rtl,504,auto,bulletedlist,528,auto,numberedlist-rtl,552,auto,numberedlist,576,auto,redo-rtl,600,auto,redo,624,auto,undo-rtl,648,auto,undo,672,auto,source-rtl,696,auto,source,720,auto', 'icons.png');
    })();
    CKEDITOR.lang.languages = {"en": 1, "pt": 1};
}());